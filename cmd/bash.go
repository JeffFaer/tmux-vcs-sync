...
func GenBashCompletionV2(c *cobra.Command, w io.Writer, includeDesc bool) error {
	return genBashCompletion(c, w, includeDesc)
}

func genBashCompletion(c *cobra.Command, w io.Writer, includeDesc bool) error {
...
func genBashComp(buf io.StringWriter, name string, includeDesc bool) {
	...
	cobra.WriteStringAndCheck(buf, fmt.Sprintf(`# bash completion V2 for %-36[1]s -*- shell-script -*-
